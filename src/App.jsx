      ...
      <header className="bg-slate-900 text-white p-3 shadow-lg sticky top-0 z-50">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-wide leading-tight">WDC计算器</h1>
              <p className="text-[10px] text-slate-400">动动手指，脑洞大开，你将决定2025年度WDC的归属</p>
            </div>
          </div>
      ...
      <main className="max-w-md mx-auto">
                      ...
                      `}>
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="flex items-center gap-2 text-[10px] text-slate-500 mt-0.5">
                            ...
                            <span className="font-medium text-slate-600">{driver.gpWins} 胜</span>
                          </div>
                        </div>
                      </td>
        ...
        <div className="mt-6 mx-4 md:mx-0 bg-slate-50 p-3 rounded-lg border border-slate-100 text-xs text-slate-500">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="font-semibold text-slate-700">决胜规则</p>
              <p>总分相同 &gt; 胜场数 &gt; 亚军数</p>
            </div>
          </div>
        </div>
